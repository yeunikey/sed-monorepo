            ...
            <div className="min-w-72 w-full md:w-72 flex flex-col gap-6">
                    ...
                    <div className="mt-3 flex flex-col gap-3">
                        <div>
                            ...
                            <div className="mt-3 ms-3 flex flex-col gap-1">
                                <div className="bg-muted py-2 px-6 rounded-full text-sm cursor-pointer">
                                    Суб-категория
                                </div>
                                <div className="py-2 px-6 rounded-full text-sm cursor-pointer">
                                    Суб-категория
                                </div>
                                <div className="py-2 px-6 rounded-full text-sm cursor-pointer">
                                    Суб-категория
                ...
                <div>
                    ...
                    <div className="mt-3 flex flex-col gap-3">
                        ...
                        <Slider.Root
                            ...
                            value={priceRange}
                            onValueChange={(e) => setPriceRange([e[0], e[1]])}
                            min={1000}
                            max={500000}
                            step={100}
                        >
                ...
                <div>
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                        <div className="py-1 px-3 bg-dark text-white font-medium rounded-full cursor-pointer">
                            Алматы
                        </div>
                        <div className="py-1 px-3 bg-muted text-dark font-medium rounded-full cursor-pointer">
                            Астана
                        </div>
                        <div className="py-1 px-3 bg-muted text-dark font-medium rounded-full cursor-pointer">
                            Шымкент
                ...
                <div>
                    ...
                    <div className="mt-3">
                        ...
                        <div className="mt-1 text-dark-light-gray">
                            В подборке 4 497 товаров из категорий
                        </div>
                    </div>
                </div>
