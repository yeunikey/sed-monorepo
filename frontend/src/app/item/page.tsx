...
export default function Item() {
    ...
    return (
        <View className="mt-12 flex flex-col gap-12" container>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="flex flex-col gap-6">
                        <div className="h-96 w-full bg-muted rounded-2xl flex justify-center items-center text-dark/25 text-7xl font-bold">
                            ТОВАР
                        </div>

                        <div ref={scrollRef} className="flex flex-row gap-2.5 overflow-x-scroll hidden-scrollbar">
                            {Array.from({ length: 10 }, (_, i) => {
                                return (
                                    <div key={i} className="min-w-36 h-20 bg-muted rounded-2xl cursor-pointer hover:border-2 hover:border-dark flex justify-center items-center text-dark/25 text-xl font-bold">
                                        ТОВАР
                                    </div>
                                )
                            })}
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex flex-row gap-3 items-center">
                                    <div className="bg-dark-light-gray rounded-full h-8 w-8" />
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="test">
                            The Nike Hoops Elite 32L Backpack Black/Silver is a black backpack with silver accents from fashion and footwear brand Nike that helps keep all your things organized and close by.
                            <br /> <br />
                            This 32L roomy backpack presents in a black colorway, and there are metallic silver accents such as Nike Swoosh on the outside facing side as well as a graphic stripe on the main outside pouch. Whether using this backpack for school, work, or sports, you&apos;ll be able to fit all your gear and daily essentials thanks to its large capacity. The Black/Silver Nike Hoops Elite 32L Backpack measurements are 19&quot; (48 cm) in height, 11&quot; (28 cm) in width, and 9&quot; (23 cm) in depth. Other details include side pockets, interior mesh pockets, haul loops, and a chest strap.
                            <br /> <br />
                            Thanks to the air units on the shoulder straps of this sleek backpack, you can enjoy cushioning and comfort while carrying all your essentials, and they are this product&apos;s unique feature. The Nike Hoops Elite 32L Backpack Black/Silver was released as part of Nike&rsquo;s spring-summer 2024 collection.
                        </div>
                    </div>
                </div>
            </div>
