            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-wrap md:flex-nowrap gap-24">
                    <div className="w-full md:w-96 xl:w-2xl flex flex-col gap-6">
                        <img src={'http://localhost:3001/v1/images/' + product.images[viewImage]} className="w-full aspect-square bg-muted rounded-2xl object-contain" />
                            ...
                            {product.images.map((image, i) => {
                                return (
                                    <SwiperSlide key={i} style={{ width: 'auto' }}>
                                        <img src={'http://localhost:3001/v1/images/' + image} className="w-24 md:min-w-20 md:w-24 xl:min-w-36 aspect-square bg-muted rounded-2xl cursor-pointer hover:border-2 hover:border-dark object-cover"
                                            onClick={() => {
                                                setViewImage(i)
                                            }}
                                        />
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex justify-between items-center">
                                ...
                                <Link href={'/profile/' + product.user.id} className="flex flex-row gap-3 items-center cursor-pointer">
                                    <img src={'http://localhost:3001/v1/images/' + product.user.image} className="bg-dark-light-gray rounded-full h-8 w-8 object-cover" />
